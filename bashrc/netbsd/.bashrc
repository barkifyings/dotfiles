...
# aliases
alias update='doas pkgin update && doas pkgin -y full-upgrade && doas pkgin -y autoremove && doas pkgin clean'
alias install='doas pkgin -y install'
alias sync='doas pkgin update'
alias remove='doas pkgin -y remove'
